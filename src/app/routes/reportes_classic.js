...
module.exports = app => {
  ...
  app.get('/class1', (req, res) => {
    connection.query('SELECT * FROM ProductoMasVendido', (err, result) => {
  ...
  app.post('/class3', (req, res) => {
    ...
    if(a1 !== undefined 
      ...
      connection.query(`call OdenarProductoProcedimiento('${a1}','${a2}','${a3}','${a4}','${a5}','${a6}','${a7}','${a8}','${a9}','${a10}','${a11}')`,
      function(err,rows) {
        if(err) {
          console.log(err);
        } else {
  ...
  app.post('/class2', (req, res) => {
    ...
    if(fecha1 !== undefined && fecha2!== undefined){
      connection.query(`call ClienteMayorCantidadComprasProcedimiento('${fecha1}','${fecha2}')`,
      function(err,rows) {
        if(err) {
            //console.log(err);
